...
python ./gan_main.py  --run_id 'new' --resume 0 --GPU '0' --device '0' --topic 'Base' --gan 'LSGAN' --loss 'base' --mode 'train' --data 'cifar10' --testcase 'few' --number '7' --num_few 250 --saver 1  --res_flag 1 --num_epochs 100  --lr_G 0.00005 --lr_D 0.00005 --paper 1 --batch_size '256' --metrics 'FID,PR' --colab 0 --pbar_flag 1 --latex_plot_flag 0

python ./gan_main.py  --run_id 'new' --resume 0 --GPU '0' --device '0' --topic 'Base' --gan 'LSGAN' --loss 'base' --mode 'train' --data 'cifar10' --testcase 'animals'  --saver 1 --res_flag 1 --num_epochs 250  --lr_G 0.00005 --lr_D 0.00005 --paper 1 --batch_size '256' --metrics 'FID,PR' --colab 0 --pbar_flag 1 --latex_plot_flag 0